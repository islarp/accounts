...
addEventHandler("onResourceStart", getResourceRootElement(getThisResource()), function()
	...
	dbExec (db, "CREATE TABLE IF NOT EXISTS InfoAccounts (ID INTEGER PRIMARY KEY, charName TEXT, charSubName TEXT, charAge INTEGER NOT NULL, accSerial TEXT, charCity TEXT)")
	print ("Table created.")
end)
